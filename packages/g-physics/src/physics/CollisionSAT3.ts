...
export abstract class CollisionSAT3 {

  public static rectanglesCollideSAT(rect1: GBox3, rect2: GBox3) {
    return CollisionSAT3.checkRectangleOverlapSat(rect1, rect2) && 
    CollisionSAT3.checkRectangleOverlapSat(rect2, rect1)
  }

  public static checkRectangleOverlapSat(rect1: GBox3, rect2: GBox3) {
    ...
    for (let i=0; i< axisProy.length; i++) {
        ...
        rect1.getNodes().forEach((v: any) => {
            let vec = new GVector3(v[0],v[1],v[2])
