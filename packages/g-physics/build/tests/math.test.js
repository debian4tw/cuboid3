...
const RectangleCentered_1 = require("../shape/RectangleCentered");
describe('DotProduct', function () {
    ...
    it('should be 0 with orthogonal vectors', function () {
        let m1 = new GVector2_1.GVector2(1, 1);
        let m2 = new GVector2_1.GVector2(-1, 1);
        let result = m1.dotProduct(m2);
        expect(result).toBe(0);
    });
...
describe('Rectangle', function () {
    it('Dimensions should match 1', function () {
        let origin = new GVector2_1.GVector2(1, 1);
        let rect = new rectangle_1.Rectangle(origin, 10, 10);
    ...
    it('Dimensions should match 2', function () {
        let origin = new GVector2_1.GVector2(0, 0);
        let rect = new rectangle_1.Rectangle(origin, 1, 1);
        let topRight = rect.getTopRight();
        let bottomRight = rect.getBottomRight();
        let topLeft = rect.getTopLeft();
        let bottomLeft = rect.getBottomLeft();
    ...
    it('rotated dimensions should match', function () {
        let origin = new GVector2_1.GVector2(0, 0);
        let rect = new rectangle_1.Rectangle(origin, Math.sqrt(2), Math.sqrt(2), 45);
        let topRight = rect.getTopRight();
        let bottomRight = rect.getBottomRight();
        let topLeft = rect.getTopLeft();
        let bottomLeft = rect.getBottomLeft();
...
describe('RectangleCentered tests', function () {
    let m1 = new RectangleCentered_1.RectangleCentered(new GVector2_1.GVector2(0, 0), 2, 2);
...
describe('RectangleCentered tests', function () {
    it('rotated 45 with origin at 0', function () {
        let m1 = new RectangleCentered_1.RectangleCentered(new GVector2_1.GVector2(0, 0), Math.sqrt(2), Math.sqrt(2), 45);
        let topRight = m1.getTopRight();
        let bottomRight = m1.getBottomRight();
        let topLeft = m1.getTopLeft();
        let bottomLeft = m1.getBottomLeft();
    ...
    it('rotated -45 with origin at 1,1', function () {
        let m1 = new RectangleCentered_1.RectangleCentered(new GVector2_1.GVector2(1, 1), Math.sqrt(2), Math.sqrt(2), -45);
        let topRight = m1.getTopRight();
        let bottomRight = m1.getBottomRight();
        let topLeft = m1.getTopLeft();
        let bottomLeft = m1.getBottomLeft();
    ...
    it('long rect with origin at 0,0', function () {
        let m1 = new RectangleCentered_1.RectangleCentered(new GVector2_1.GVector2(0, 0), 20, 2, 0);
        let topRight = m1.getTopRight();
        let bottomRight = m1.getBottomRight();
        let topLeft = m1.getTopLeft();
        let bottomLeft = m1.getBottomLeft();
    ...
    it('long rect rotated 90 with origin at 0,0', function () {
        let m1 = new RectangleCentered_1.RectangleCentered(new GVector2_1.GVector2(0, 0), 20, 2, 90);
        let topRight = m1.getTopRight();
        let bottomRight = m1.getBottomRight();
        let topLeft = m1.getTopLeft();
        let bottomLeft = m1.getBottomLeft();
    ...
    it('long rect rotated 90 with origin at 0,0', function () {
        let m2 = new RectangleCentered_1.RectangleCentered(new GVector2_1.GVector2(10, 0), 10, 2, 0);
        m2.rotateOnPivot(new GVector2_1.GVector2(0, 0), 90);
