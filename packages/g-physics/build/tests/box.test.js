...
const Box_1 = require("../shape/Box");
describe('Box 3 Test', function () {
    it('dimensions should match for 2,2,2 box ', function () {
        let m1 = new Box_1.Box(new GVector3_1.GVector3(0, 0, 0), 2, 2, 2);
        let RUF = m1.getRUF();
        console.log('RUF', RUF);
        expect(RUF.x).toBe(1);
        expect(RUF.y).toBe(1);
    ...
    it('dimensions should match for 4,4,4 box', function () {
        let m1 = new Box_1.Box(new GVector3_1.GVector3(0, 0, 0), 4, 4, 4);
        let RUF = m1.getRUF();
        console.log('RUF', RUF);
        expect(RUF.x).toBe(2);
        expect(RUF.y).toBe(2);
    ...
    it('dimensions should match for 10,2,2', function () {
        let m1 = new Box_1.Box(new GVector3_1.GVector3(0, 0, 0), 10, 2, 2);
        let RUF = m1.getRUF();
        console.log('RUF', RUF);
        expect(RUF.x).toBe(5);
        expect(RUF.y).toBe(1);
    ...
    it('dimensions should match for 2,2,2 box with offeset center', function () {
        let m1 = new Box_1.Box(new GVector3_1.GVector3(1, 1, 1), 2, 2, 2);
        let RUF = m1.getRUF();
        console.log('RUF', RUF);
        expect(RUF.x).toBe(2);
        expect(RUF.y).toBe(2);
    ...
    it('dimensions should match for 10,2,10', function () {
        let m1 = new Box_1.Box(new GVector3_1.GVector3(0, 0, 0), 10, 2, 10);
        let RUF = m1.getRUF();
        console.log('RUF', RUF);
        expect(RUF.x).toBe(5);
        expect(RUF.y).toBe(1);
