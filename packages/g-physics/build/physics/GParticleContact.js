...
exports.GParticleContact = void 0;
const GMath_1 = require("../math/GMath");
class GParticleContact {
    constructor(particles, restitution, contactNormal) {
        this.particles = particles;
        this.restitution = restitution;
        this.contactNormal = contactNormal;
        this.particlesMovement = [new GMath_1.GVector3(0, 0, 0), new GMath_1.GVector3(0, 0, 0)];
    }
    resolve(duration) {
    ...
    */
    ...
    resolveInterpenetration(duration) {
        ...
        const movePerIMass = this.contactNormal.copy().multiplyScalar(this.penetration / totalInverseMass);
...
exports.GParticleContact = GParticleContact;
