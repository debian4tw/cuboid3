...
exports.ClientSingleTranslatedActor = void 0;
const THREE = __importStar(require("three"));
const ClientActor_1 = require("./ClientActor");
const GeometryFactory_1 = require("./GeometryFactory");
class ClientSingleTranslatedActor extends ClientActor_1.ClientActor {
    constructor(actor) {
        //this.scene = scene;
        super(actor);
...
exports.ClientSingleTranslatedActor = ClientSingleTranslatedActor;
